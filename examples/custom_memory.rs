//! Example: Implementing a custom Memory backend for CrabClaw
//!
...
// ── Re-define the trait types (in your app, import from crabclaw::memory) ──
...
async fn main() -> anyhow::Result<()> {
    ...
    println!("🧠 CrabClaw Memory Demo — InMemoryBackend\n");
