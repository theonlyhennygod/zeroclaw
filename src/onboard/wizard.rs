...
fn setup_provider() -> Result<(String, String, String)> {
    ...
    let providers: Vec<(&str, &str)> = match tier_idx {
        ...
        3 => vec![
            ("moonshot", "Moonshot — Kimi K2 models (intl)"),
            ("moonshot-cn", "Moonshot China — Kimi K2 models (cn)"),
            ("kimi-coding", "Kimi Coding — K2.5 for coding"),
    ...
    let models: Vec<(&str, &str)> = match provider_name {
        ...
        "moonshot" | "moonshot-cn" => vec![
            ("kimi-k2.5", "Kimi K2.5 (latest, recommended)"),
        ...
        "kimi-coding" => vec![("k2p5", "K2.5 (coding optimized)")],
        "glm" => vec![
