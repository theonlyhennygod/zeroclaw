//! Integrator — generates CrabClaw-standard SKILL.toml + SKILL.md from scout results.
...
mod tests {
    ...
    fn integrate_creates_files() {
        let tmp = std::env::temp_dir().join("crabclaw-test-integrate");
